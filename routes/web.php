...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/admin/pos/refresh-products', [OrdersController::class, 'refreshPOSProducts'])
    ->name('admin.pos.refresh')
    ->middleware(['auth']);

// Route untuk mendapatkan stok produk real-time
Route::get('/admin/pos/product-stock/{productId}', [OrdersController::class, 'getProductStock'])
    ->name('admin.pos.product.stock')
    ->middleware(['auth']);
...
Route::middleware(['auth'])->prefix('admin')->name('admin.')->group(function () {
    Route::prefix('pos')->name('pos.')->group(function () {
        Route::get('refresh-products', [OrdersController::class, 'refreshPOSProducts'])->name('refresh');
        Route::get('product-stock/{productId}', [OrdersController::class, 'getProductStock'])->name('product.stock');
    });
});
    ...
    Route::get('/reports/profit', [OrdersController::class, 'profitReport'])
        ...
        ->middleware('role:admin,guru');
        // Pastikan route ini ada di dalam group middleware yang benar (cth: auth, supervisor)
Route::get('/supervisor/profit/chart', [OrdersController::class, 'getChartData'])->name('supervisor.profit.chart');

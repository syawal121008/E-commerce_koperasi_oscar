...
class TopupController extends Controller
{
    ...
    public function approve(Request $request, $topupId)
    {
        ...
        try {
            ...
            return back()->with('success', 'Top up approved paidfully');
    ...
    public function reject(Request $request, $topupId)
    {
        ...
        try {
            ...
            return back()->with('success', 'Top up rejected paidfully');
    ...
    private function getTopupStatistics(Request $request)
    {
        ...
        return [
            ...
            'paid_amount' => $allTopups->where('status', 'success')->sum('amount'),

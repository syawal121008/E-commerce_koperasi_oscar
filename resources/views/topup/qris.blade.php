<x-app-layout>
                        ...
                        <div class="bg-gradient-to-br from-indigo-50 to-blue-50 p-8 rounded-2xl border border-indigo-200 shadow-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="payment-option selected p-4 text-center cursor-pointer bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg shadow-md">
                                    ...
                                    <p class="text-xs opacity-90">Pindai & Bayar dengan aplikasi favorit Anda</p>
                                </div>
                            </div>
                            ...
                            <div class="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
                                ...
                                <ol class="list-decimal list-inside space-y-3 text-gray-600">
                                    <li class="flex items-start">
                                        ...
                                        <span>Masukkan nominal yang ingin anda isi</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="mr-2">2.</span>
                                        <span>Klik "Buat Kode QR" untuk mendapatkan QR pembayaran</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="mr-2">3.</span>
                                        <span>Pindai QR Code dengan aplikasi pembayaran Anda</span>
                                    </li>
                                    <li class="flex items-start">
    ...
    <script>
        ...
        document.getElementById('generateQRBtn').addEventListener('click', function() {
            ...
            if (amount > 500000) {
                Swal.fire({
                    ...
                    text: 'Maksimum top up adalah Rp 500.000',
                    icon: 'warning',
                    confirmButtonColor: '#f59e0b'
                });
                return;
        ...
        document.getElementById('submitBtn').addEventListener('click', function(e) {
            ...
            submitBtn.disabled = true;
            submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i>Mengecek Bukti Transfer...';

            // --- SIMULASI PENGECEKAN BUKTI TRANSFER ---
            setTimeout(() => {
                // Generate a random outcome for the simulation
                const isValidationpaidful = Math.random() > 0.1; // 90% paid rate for simulation

                if (isValidationpaidful) {
                    // Simulated paid
                    ...
                    Swal.fire({
                        ...
                        text: 'Bukti transfer tidak valid atau nominal tidak cocok. Silakan coba lagi.',
                        icon: 'error',
                        confirmButtonColor: '#dc2626'
                    });
                    submitBtn.disabled = false;
            ...
            }, 2000); // Wait for 2 seconds to simulate checking
        });

<x-app-layout>
    ...
    <script>
        ...
        function updateAmounts() {
            ...
            // Update hidden input with raw amount for backend
        ...
        function setAmount(amount) {
            document.getElementById('nominalInput').value = formatRupiah(amount).replace('Rp ', '');
            updateAmounts();
        }
        ...
        document.getElementById('submitBtn').addEventListener('click', function(e) {
            ...
            // Simulate checking
            setTimeout(() => {
                const isValidationSuccessful = Math.random() > 0.1; // 90% success rate for simulation

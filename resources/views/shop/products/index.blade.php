                ...
                @if($products->count() > 0)
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3 md:gap-6">
                        @foreach($products as $product)
                            ...
                            class="product-card bg-white rounded-lg shadow-md overflow-hidden transform hover:-translate-y-1 transition-all duration-300 hover:shadow-lg flex flex-col">
                                ...
                                <!-- Product Info -->
                                <div class="product-info p-2 sm:p-3 md:p-4 flex flex-col flex-1">
                                    <!-- Product Name -->
                                    ...
                                    <!-- Rating -->
                                    <div class="flex items-center mb-1 sm:mb-2 min-h-[1.25rem]">
                                        @for ($i = 1; $i <= 5; $i++)
                                            @if ($i <= round($product->avg_rating))
                                                <i class="fas fa-star text-yellow-400 text-[10px] sm:text-xs"></i>
                                            @else
                                                <i class="far fa-star text-gray-300 text-[10px] sm:text-xs"></i>
                                            @endif
                                        @endfor
                                        <span class="text-[10px] sm:text-xs text-gray-500 ml-1">({{ $product->reviews_count }})</span>
                                    </div>
